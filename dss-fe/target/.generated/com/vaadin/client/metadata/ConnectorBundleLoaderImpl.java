...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.CustomField","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.TwinColSelect","com.vaadin.ui.Form","com.vaadin.ui.InlineDateField","com.vaadin.ui.Accordion","com.vaadin.ui.ProgressBar","com.vaadin.ui.CheckBox","com.vaadin.server.FileDownloader","com.vaadin.ui.GridLayout","com.vaadin.ui.Image","com.vaadin.ui.Embedded","com.vaadin.ui.PopupView","com.vaadin.ui.Label","com.vaadin.ui.DateField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Panel","com.vaadin.ui.TextArea","com.vaadin.ui.OptionGroup","com.vaadin.ui.CustomLayout","com.vaadin.ui.CssLayout","com.vaadin.ui.FormLayout","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Window","com.vaadin.ui.Link","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.NativeButton","com.vaadin.ui.NativeSelect","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.TabSheet","com.vaadin.ui.TextField","com.vaadin.ui.Slider","com.vaadin.ui.JavaScript","com.vaadin.ui.Table","com.vaadin.ui.Upload","com.vaadin.ui.CustomComponent","com.vaadin.ui.TreeTable","com.vaadin.ui.Button","com.vaadin.ui.HorizontalLayout","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.VerticalLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.Flash","com.vaadin.ui.Audio","com.vaadin.ui.UI","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.MenuBar","com.vaadin.ui.PasswordField","com.vaadin.ui.Video","com.vaadin.ui.ListSelect","com.vaadin.ui.Tree",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"resources", "immediate", "styles", "primaryStyleName", "enabled", "templateContents", "readOnly", "description", "width", "caption", "id", "childLocations", "height", "registeredEventListeners", "templateName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"immediate", "enabled", "windowMode", "primaryStyleName", "centered", "height", "id", "scrollLeft", "positionY", "styles", "modal", "positionX", "resources", "resizable", "width", "readOnly", "scrollTop", "description", "registeredEventListeners", "tabIndex", "errorMessage", "caption", "resizeLazy", "draggable", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"rangeStart", "width", "registeredEventListeners", "errorMessage", "styles", "hideErrors", "caption", "primaryStyleName", "height", "enabled", "required", "modified", "resources", "immediate", "id", "rangeEnd", "tabIndex", "readOnly", "propertyReadOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"description", "errorMessage", "registeredEventListeners", "html", "id", "primaryStyleName", "readOnly", "width", "height", "enabled", "hideOnMouseOut", "caption", "styles", "immediate", "resources", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"height", "required", "width", "propertyReadOnly", "description", "primaryStyleName", "resources", "errorMessage", "styles", "enabled", "id", "registeredEventListeners", "hideErrors", "caption", "modified", "tabIndex", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"id", "tabIndex", "layout", "propertyReadOnly", "hideErrors", "height", "resources", "width", "errorMessage", "primaryStyleName", "enabled", "description", "modified", "required", "caption", "styles", "readOnly", "registeredEventListeners", "footer", "immediate", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"id", "errorMessage", "registeredEventListeners", "caption", "styles", "firstChild", "enabled", "splitterState", "description", "primaryStyleName", "resources", "immediate", "secondChild", "height", "readOnly", "width", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"width", "immediate", "height", "primaryStyleName", "readOnly", "enabled", "resources", "styles", "errorMessage", "caption", "alternateText", "id", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"id", "errorMessage", "resources", "registeredEventListeners", "caption", "height", "width", "primaryStyleName", "enabled", "readOnly", "description", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"immediate", "height", "description", "enabled", "propertyReadOnly", "errorMessage", "id", "primaryStyleName", "width", "modified", "tabIndex", "registeredEventListeners", "styles", "resources", "readOnly", "required", "caption", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"name", "dateFormat", "hourMinuteDelimiter", "pm", "firstDayOfWeek", "shortDayNames", "am", "twelveHourClock", "dayNames", "shortMonthNames", "monthNames", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LoadingIndicatorConfigurationState.class, new String[] {"thirdDelay", "secondDelay", "firstDelay", });
            store.setProperties(com.vaadin.shared.ui.ui.PageState.class, new String[] {"hasResizeListeners", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"enabled", "styles", "autoplay", "sources", "resources", "primaryStyleName", "immediate", "id", "altText", "width", "description", "errorMessage", "height", "showControls", "sourceTypes", "muted", "caption", "registeredEventListeners", "htmlContentAllowed", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"registeredEventListeners", "width", "resources", "readOnly", "scrollLeft", "tabIndex", "id", "immediate", "caption", "primaryStyleName", "scrollTop", "styles", "errorMessage", "enabled", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"width", "propertyReadOnly", "description", "immediate", "columns", "id", "registeredEventListeners", "modified", "readOnly", "caption", "height", "enabled", "inputPrompt", "primaryStyleName", "rows", "errorMessage", "text", "hideErrors", "resources", "required", "styles", "tabIndex", "maxLength", "wordwrap", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"modified", "readOnly", "width", "tabIndex", "hideErrors", "styles", "registeredEventListeners", "enabled", "errorMessage", "propertyReadOnly", "caption", "id", "description", "required", "immediate", "resources", "primaryStyleName", "height", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"errorMessage", "description", "width", "spacing", "marginsBitmask", "id", "registeredEventListeners", "primaryStyleName", "resources", "readOnly", "childData", "height", "styles", "immediate", "enabled", "caption", });
            store.setProperties(java.util.Date.class, new String[] {"time", "seconds", "date", "hours", "year", "month", "minutes", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"tabIndex", "clickShortcutKeyCode", "width", "readOnly", "immediate", "caption", "id", "description", "height", "htmlContentAllowed", "iconAltText", "styles", "disableOnClick", "primaryStyleName", "registeredEventListeners", "resources", "enabled", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"registeredEventListeners", "modified", "width", "errorMessage", "indeterminate", "caption", "propertyReadOnly", "resources", "description", "hideErrors", "state", "id", "styles", "height", "enabled", "pollingInterval", "required", "primaryStyleName", "tabIndex", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"readOnly", "caption", "errorMessage", "description", "registeredEventListeners", "primaryStyleName", "resources", "styles", "immediate", "width", "enabled", "alternateText", "height", "id", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"hideErrors", "errorMessage", "propertyReadOnly", "tabIndex", "registeredEventListeners", "readOnly", "required", "modified", "enabled", "id", "description", "resources", "styles", "primaryStyleName", "width", "height", "immediate", "checked", "caption", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"tabIndex", "primaryStyleName", "caption", "width", "resources", "immediate", "errorMessage", "enabled", "styles", "readOnly", "registeredEventListeners", "description", "id", "height", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"inputPrompt", "propertyReadOnly", "required", "enabled", "styles", "hideErrors", "text", "description", "maxLength", "immediate", "tabIndex", "registeredEventListeners", "caption", "resources", "width", "modified", "errorMessage", "height", "readOnly", "columns", "id", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"width", "resources", "primaryStyleName", "readOnly", "registeredEventListeners", "caption", "id", "errorMessage", "height", "description", "enabled", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"errorMessage", "callbackNames", "description", "primaryStyleName", "resources", "immediate", "styles", "enabled", "rpcInterfaces", "readOnly", "caption", "registeredEventListeners", "id", "height", "width", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"enabled", "resources", "immediate", "id", "width", "caption", "registeredEventListeners", "height", "marginsBitmask", "description", "readOnly", "primaryStyleName", "childData", "spacing", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"resources", "enabled", "id", "styles", "width", "height", "readOnly", "errorMessage", "secondChild", "description", "registeredEventListeners", "splitterState", "primaryStyleName", "caption", "firstChild", "immediate", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "registeredEventListeners", "enabled", "rpcInterfaces", "resources", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "styles", "errorMessage", "resources", "immediate", "primaryStyleName", "description", "width", "registeredEventListeners", "readOnly", "caption", "id", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"resources", "resolution", "propertyReadOnly", "modified", "height", "minValue", "required", "id", "maxValue", "primaryStyleName", "immediate", "enabled", "styles", "value", "width", "description", "errorMessage", "tabIndex", "hideErrors", "caption", "readOnly", "registeredEventListeners", "orientation", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"caption", "styles", "primaryStyleName", "registeredEventListeners", "description", "errorMessage", "height", "width", "id", "alternateText", "immediate", "readOnly", "enabled", "resources", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"primaryStyleName", "registeredEventListeners", "spacing", "immediate", "caption", "resources", "errorMessage", "enabled", "width", "childData", "id", "marginsBitmask", "styles", "height", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"readOnly", "propertyReadOnly", "styles", "immediate", "errorMessage", "height", "description", "hideErrors", "tabIndex", "width", "modified", "resources", "registeredEventListeners", "enabled", "id", "primaryStyleName", "caption", "required", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"resources", "primaryStyleName", "htmlContentAllowed", "width", "iconAltText", "styles", "immediate", "enabled", "disableOnClick", "errorMessage", "caption", "height", "id", "readOnly", "description", "registeredEventListeners", "clickShortcutKeyCode", "tabIndex", });
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row1", "row2", "column1", "column2", "alignment", });
            ...
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPosition", "position", "minPositionUnit", "minPosition", "positionReversed", "maxPositionUnit", "locked", "positionUnit", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"required", "propertyReadOnly", "rangeEnd", "registeredEventListeners", "height", "textFieldEnabled", "description", "readOnly", "immediate", "id", "resources", "rangeStart", "hideErrors", "styles", "tabIndex", "enabled", "width", "modified", "errorMessage", "descriptionForAssistiveDevices", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"resources", "readOnly", "description", "id", "primaryStyleName", "enabled", "registeredEventListeners", "height", "width", "errorMessage", "immediate", "styles", "connectorToCssPosition", "caption", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"enabled", "styles", "parameters", "width", "id", "caption", "resources", "target", "immediate", "registeredEventListeners", "errorMessage", "primaryStyleName", "description", "readOnly", "features", "uriFragment", "height", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"errorMessage", "localeServiceState", "caption", "resources", "pollInterval", "overlayContainerLabel", "id", "pageState", "loadingIndicatorConfiguration", "primaryStyleName", "height", "tooltipConfiguration", "pushConfiguration", "styles", "tabIndex", "registeredEventListeners", "width", "readOnly", "immediate", "description", "enabled", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"relativeY", "altKey", "relativeX", "shiftKey", "clientX", "button", "clientY", "ctrlKey", "metaKey", "type", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"height", "text", "readOnly", "errorMessage", "enabled", "contentMode", "immediate", "styles", "id", "resources", "width", "registeredEventListeners", "description", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"primaryStyleName", "codetype", "standby", "classId", "description", "styles", "width", "height", "resources", "id", "caption", "enabled", "embedParams", "readOnly", "registeredEventListeners", "alternateText", "errorMessage", "codebase", "immediate", "archive", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"required", "hideErrors", "immediate", "styles", "state", "modified", "description", "indeterminate", "caption", "enabled", "registeredEventListeners", "readOnly", "errorMessage", "tabIndex", "id", "propertyReadOnly", "height", "resources", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"width", "immediate", "styles", "errorMessage", "description", "primaryStyleName", "required", "hideErrors", "id", "registeredEventListeners", "enabled", "modified", "caption", "resources", "tabIndex", "readOnly", "height", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"registeredEventListeners", "width", "immediate", "propertyReadOnly", "required", "caption", "modified", "readOnly", "primaryStyleName", "errorMessage", "id", "height", "hideErrors", "enabled", "resources", "tabIndex", "description", "styles", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"id", "registeredEventListeners", "propertyReadOnly", "readOnly", "hideErrors", "immediate", "caption", "resources", "description", "height", "required", "errorMessage", "primaryStyleName", "enabled", "tabIndex", "modified", "width", "styles", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"htmlContentAllowed", "caption", "primaryStyleName", "enabled", "styles", "altText", "sources", "showControls", "sourceTypes", "description", "errorMessage", "width", "height", "registeredEventListeners", "immediate", "resources", "autoplay", "readOnly", "id", "muted", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"childCss", "resources", "enabled", "description", "height", "errorMessage", "registeredEventListeners", "caption", "readOnly", "primaryStyleName", "id", "width", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"height", "rows", "immediate", "styles", "childData", "marginsBitmask", "description", "primaryStyleName", "registeredEventListeners", "id", "columns", "spacing", "resources", "width", "enabled", "errorMessage", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"maxWidth", "closeTimeout", "openDelay", "quickOpenDelay", "quickOpenTimeout", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"dateTo", "styleName", "allDay", "caption", "index", "description", "dateFrom", "timeTo", "timeFrom", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"localizedDateFormat", "dayOfWeek", "week", "date", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"actionKey", "endDate", "iconKey", "caption", "startDate", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"registeredEventListeners", "readOnly", "description", "actions", "now", "resources", "firstHourOfDay", "firstVisibleDayOfWeek", "height", "enabled", "days", "immediate", "primaryStyleName", "format24H", "events", "id", "lastVisibleDayOfWeek", "dayNames", "styles", "firstDayOfWeek", "errorMessage", "lastHourOfDay", "monthNames", "scroll", "width", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"registeredEventListeners", "immediate", "caption", "enabled", "height", "id", "readOnly", "styles", "primaryStyleName", "bgColor", "cursorX", "cursorY", "width", "resources", "description", "errorMessage", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"resources", "htmlContentAllowed", "height", "errorMessage", "styles", "popupVisible", "width", "immediate", "description", "caption", "readOnly", "enabled", "id", "primaryStyleName", "registeredEventListeners", "color", "showDefaultCaption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"registeredEventListeners", "rowCount", "enabled", "caption", "columnCount", "readOnly", "errorMessage", "primaryStyleName", "height", "width", "immediate", "changedColor", "changedX", "description", "changedY", "styles", "id", "resources", });
